<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="用户名字" width="120px" align="center">
      ...
      <el-table-column label="账户情况" width="100px" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.userStatus }}</span>
        </template>
      </el-table-column>
      <el-table-column label="用户号" width="150px" align="center">
        <template slot-scope="scope">
...
import { pagedSystemAdmin } from '@/api/user'
...
export default {
  ...
  methods: {
    getList() {
      pagedSystemAdmin(this.listQuery).then(response => {
